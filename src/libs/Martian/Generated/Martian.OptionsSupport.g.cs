...
namespace Martian
{
    ...
    public sealed class AutoSDKClientOptions
    {
        ...
        /// </summary>
        public global::Martian.AutoSDKRetryOptions Retry { get; set; } = new global::Martian.AutoSDKRetryOptions();
        ...
        /// </summary>
        public global::System.Collections.Generic.List<global::Martian.IAutoSDKHook> Hooks { get; } =
            new global::System.Collections.Generic.List<global::Martian.IAutoSDKHook>();
        ...
        public global::Martian.AutoSDKClientOptions AddHook(
            global::Martian.IAutoSDKHook hook)
        {
        ...
        /// </summary>
        public global::Martian.IAutoSDKAuthorizationProvider? AuthorizationProvider { get; set; }
        ...
        public global::Martian.AutoSDKClientOptions UseAuthorizationProvider(
            global::Martian.IAutoSDKAuthorizationProvider provider)
        {
            AuthorizationProvider = provider ?? throw new global::System.ArgumentNullException(nameof(provider));
            if (Hooks.Find(static x => x is global::Martian.AutoSDKAuthorizationProviderHook) == null)
            {
                Hooks.Add(new global::Martian.AutoSDKAuthorizationProviderHook());
            }
    ...
    public readonly struct AutoSDKAuthorizationValue
    {
        ...
        public static global::Martian.AutoSDKAuthorizationValue Bearer(string token) => new(value: token, scheme: "Bearer");

        /// <summary>Convenience factory for an API-key header.</summary>
        public static global::Martian.AutoSDKAuthorizationValue ApiKeyHeader(string name, string value) =>
    ...
    public interface IAutoSDKAuthorizationProvider
    {
        ...
        global::System.Threading.Tasks.Task<global::System.Collections.Generic.IReadOnlyList<global::Martian.AutoSDKAuthorizationValue>?> ResolveAsync(
            global::Martian.AutoSDKHookContext context);
    }
...
#pragma warning restore CS0618
    ...
    /// </summary>
    public sealed class AutoSDKAuthorizationProviderHook : global::Martian.AutoSDKHook
    {
        /// <inheritdoc />
            ...
            global::Martian.AutoSDKHookContext context)
        {
            ...
            if (perRequest != null && perRequest.Count > 0)
            {
                ...
                global::Martian.AutoSDKHttpRequestOptions.StampAuthorizationOverride(context.Request);
                return;
            }
        ...
        private static void ApplyAuthorization(
            global::System.Net.Http.HttpRequestMessage request,
            global::Martian.AutoSDKAuthorizationValue authorization)
        {
    ...
    public sealed class AutoSDKRequestOptions
    {
        ...
        /// </summary>
        public global::Martian.AutoSDKRetryOptions? Retry { get; set; }
        ...
        /// </summary>
        public global::System.Collections.Generic.IReadOnlyList<global::Martian.AutoSDKAuthorizationValue>? Authorizations { get; set; }
    }
    ...
    /// </summary>
    public abstract class AutoSDKHook : global::Martian.IAutoSDKHook
    {
        /// <inheritdoc />
    ...
    public sealed class AutoSDKHookContext
    {
        ...
        /// </summary>
        public global::Martian.AutoSDKClientOptions ClientOptions { get; set; } = null!;

        /// <summary>
        /// The per-request runtime options.
        /// </summary>
        public global::Martian.AutoSDKRequestOptions? RequestOptions { get; set; }
    ...
    {
        internal static global::Martian.AutoSDKHookContext CreateHookContext(
            string operationId,
            string methodName,
            string pathTemplate,
            string httpMethod,
            ...
            global::Martian.AutoSDKClientOptions clientOptions,
            global::Martian.AutoSDKRequestOptions? requestOptions,
            int attempt,
            int maxAttempts,
            bool willRetry,
        ...
        {
            return new global::Martian.AutoSDKHookContext
            {
        ...
        internal static global::System.TimeSpan GetRetryDelay(
            ...
            int attempt)
        {
            var retryOptions = requestOptions?.Retry ?? clientOptions.Retry ?? new global::Martian.AutoSDKRetryOptions();
        ...
        private static global::System.TimeSpan ClampRetryDelay(
            global::System.TimeSpan delay,
            global::Martian.AutoSDKRetryOptions retryOptions)
        {
        ...
        private static async global::System.Threading.Tasks.Task InvokeHooksAsync(
            global::Martian.AutoSDKClientOptions clientOptions,
            global::System.Func<global::Martian.IAutoSDKHook, global::Martian.AutoSDKHookContext, global::System.Threading.Tasks.Task> callback,
            global::Martian.AutoSDKHookContext context)
        {
