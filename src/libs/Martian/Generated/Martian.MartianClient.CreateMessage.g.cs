...
namespace Martian
{
    public partial class MartianClient
    {
        ...
        private static readonly global::Martian.EndPointSecurityRequirement s_CreateMessageSecurityRequirement0 =
        ...
        private static readonly global::Martian.EndPointSecurityRequirement[] s_CreateMessageSecurityRequirements =
            new global::Martian.EndPointSecurityRequirement[]
        ...
        public async global::System.Threading.Tasks.Task<global::Martian.MessagesResponse> CreateMessageAsync(
        ...
        /// <param name="cancellationToken">The token to cancel the operation with</param>
        /// <exception cref="global::Martian.ApiException"></exception>
        public async global::System.Threading.Tasks.Task<global::Martian.AutoSDKHttpResponse<global::Martian.MessagesResponse>> CreateMessageAsResponseAsync(
            ...
            global::System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            using var __timeoutCancellationTokenSource = global::Martian.AutoSDKRequestOptionsSupport.CreateTimeoutCancellationTokenSource(
                clientOptions: Options,
                requestOptions: requestOptions,
                cancellationToken: cancellationToken);
            var __effectiveCancellationToken = __timeoutCancellationTokenSource?.Token ?? cancellationToken;
            var __effectiveReadResponseAsString = global::Martian.AutoSDKRequestOptionsSupport.GetReadResponseAsString(
                clientOptions: Options,
                requestOptions: requestOptions,
                fallbackValue: ReadResponseAsString);
            var __maxAttempts = global::Martian.AutoSDKRequestOptionsSupport.GetMaxAttempts(
                clientOptions: Options,
                requestOptions: requestOptions,
                supportsRetry: false);
            ...
            global::System.Net.Http.HttpRequestMessage __CreateHttpRequest()
            {
                ...
                __path = global::Martian.AutoSDKRequestOptionsSupport.AppendQueryParameters(
                    path: __path,
            ...
            foreach (var __authorization in __authorizations)
            {
                ...
                global::Martian.AutoSDKRequestOptionsSupport.ApplyHeaders(
            ...
            try
            {
                for (var __attempt = 1; __attempt <= __maxAttempts; __attempt++)
                {
                    ...
                    await global::Martian.AutoSDKRequestOptionsSupport.OnBeforeRequestAsync(
                            clientOptions: Options,
                            context: global::Martian.AutoSDKRequestOptionsSupport.CreateHookContext(
                ...
                cancellationToken: __effectiveCancellationToken).ConfigureAwait(false);
                    ...
                    {
                        var __retryDelay = global::Martian.AutoSDKRequestOptionsSupport.GetRetryDelay(
                            clientOptions: Options,
                            requestOptions: requestOptions,
                            response: null,
                            attempt: __attempt);
                        var __willRetry = __attempt < __maxAttempts && !__effectiveCancellationToken.IsCancellationRequested;
                        await global::Martian.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            clientOptions: Options,
                            context: global::Martian.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateMessage",
                                methodName: "CreateMessageAsync",
                        ...
                        __httpRequest = null;
                        await global::Martian.AutoSDKRequestOptionsSupport.DelayBeforeRetryAsync(
                    ...
                    if (__response != null &&
                        ...
                        global::Martian.AutoSDKRequestOptionsSupport.ShouldRetryStatusCode(__response.StatusCode))
                    {
                        var __retryDelay = global::Martian.AutoSDKRequestOptionsSupport.GetRetryDelay(
                            clientOptions: Options,
                            requestOptions: requestOptions,
                ...
                {
                    await global::Martian.AutoSDKRequestOptionsSupport.OnAfterSuccessAsync(
                            clientOptions: Options,
                            context: global::Martian.AutoSDKRequestOptionsSupport.CreateHookContext(
                                operationId: "CreateMessage",
                                methodName: "CreateMessageAsync",
                ...
                else
                {
                    await global::Martian.AutoSDKRequestOptionsSupport.OnAfterErrorAsync(
                            ...
                            if ((int)__response.StatusCode == 400)
                            {
                                ...
                                throw global::Martian.ApiException<global::Martian.ErrorResponse>.Create(
                            ...
                            if (__effectiveReadResponseAsString)
                            {
                                ...
                                try
                                {
                                    ...
                                    var __value = global::Martian.MessagesResponse.FromJson(__content, JsonSerializerContext) ??
                                        throw new global::System.InvalidOperationException($"Response deserialization failed for \"{__content}\" ");
                                    return new global::Martian.AutoSDKHttpResponse<global::Martian.MessagesResponse>(
                                        statusCode: __response.StatusCode,
                                        headers: global::Martian.AutoSDKHttpResponse.CreateHeaders(__response),
                                        requestUri: __response.RequestMessage?.RequestUri,
                                        body: __value);
                                }
                                catch (global::System.Exception __ex)
                                {
                                    throw global::Martian.ApiException.Create(
                                        statusCode: __response.StatusCode,
                            ...
                            else
                            {
                                try
                                {
                                    ...
                                    var __value = await global::Martian.MessagesResponse.FromJsonStreamAsync(__content, JsonSerializerContext).ConfigureAwait(false) ??
