...
internal static class CliRuntime
{
    ...
    public static async Task<global::Martian.MartianClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
    ...
    private static async Task WriteApiExceptionAsync(global::Martian.ApiException exception)
    {
        var builder = new StringBuilder();
