...
namespace Martian.CLI;

internal static class CliRuntime
{
    private const string UserSecretsId = "Martian.CLI";
    private const string UserSecretApiKeyName = "MARTIAN_API_KEY";
    private static readonly string[] ApiKeyEnvironmentVariables = [@"MARTIAN_API_KEY"];
    private const string CredentialFileDirectoryName = ".martian";

    public static async global::System.Threading.Tasks.Task<global::Martian.MartianClient> CreateClientAsync(ParseResult parseResult, CancellationToken cancellationToken = default)
    {
        ...
        var authorizations = string.IsNullOrWhiteSpace(apiKey)
            ? new global::System.Collections.Generic.List<global::Martian.EndPointAuthorization>()
            : new global::System.Collections.Generic.List<global::Martian.EndPointAuthorization>
            {
        CreateAuthorization(
            type: "Http",
        ...
        return new global::Martian.MartianClient(
            httpClient: null,
            baseUri: baseUri,
    ...
    private static global::Martian.EndPointAuthorization CreateAuthorization(
        string type,
        string schemeId,
        string location,
        string name,
        string value)
    {
        var authorization = new global::Martian.EndPointAuthorization
        {
            Type = type,
            Location = location,
            Name = name,
        ...
        var schemeIdProperty = typeof(global::Martian.EndPointAuthorization).GetProperty("SchemeId");
    ...
    public static async global::System.Threading.Tasks.Task<int> RunAsync(Func<global::System.Threading.Tasks.Task> action, CancellationToken cancellationToken = default)
    {
        ...
        catch (global::Martian.ApiException exception)
        {
    ...
    private static Uri? ResolveBaseUri(ParseResult parseResult)
    {
        ...
        {
            baseUrl = Environment.GetEnvironmentVariable("MARTIAN_BASE_URL");
        }
    ...
    private static async global::System.Threading.Tasks.Task WriteApiExceptionAsync(global::Martian.ApiException exception)
    {
        var builder = new StringBuilder();
